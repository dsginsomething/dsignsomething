                ...
                <div class="eleven wide column">
                    <div class="ui grid">
                        <div class="sixteen wide column">
                            <h1 class="ui header dividing spotlight">D<span class="disabled">SIGNER DIRECTORY</span></h1>
                        </div>
                        <div class="sixteen wide column">
                            <?php get_template_part('custom-search/dsigner', 'search'); ?>
                        </div>
                    </div>
