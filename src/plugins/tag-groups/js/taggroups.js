...
function tg_do_ajax(tg_params, send_data, labels) {
     ...
     */
    jQuery.post(tg_params.ajaxurl, send_data, function (data) {
        ...
        if (status == 'success') {
            ...
            if (max_number > 0) {
                for (var key in groups) {
                    ...
                    output += "<tr style='height:50px;' class='tg_sort_tr' data-position='" + position + "'>\n";
                    output += "<td>" + data_set['id'] + "</td>\n";
                    output += "<td><span class='tg_edit_label tg_text' data-position='" + position + "' data-label='" + escape_html(data_set['label']) + "'>" + escape_html(data_set['label']) + "\
<span class='dashicons dashicons-edit tg_pointer' style='display:none;'></span></span></td>\n";
                    output += "<td>" + data_set['amount'] + "</td>\n";
                    output += "<td>";
                    ...
                    output += "<td style='display:none;'>" + labels.new + "</td>\n";
                ...
                output += "<td ></td>\n";
                output += "<td colspan='4'><input data-position='1' placeholder='" + labels.new + "'>";
            ...
            if (message != '') {
                message_output += '<div class="updated fade"><p>' + message + '</p></div><br clear="all" />';
            }
            ...
            if (message != '') {
                message_output += '<div class="error fade"><p>' + message + '</p></div><br clear="all" />';
